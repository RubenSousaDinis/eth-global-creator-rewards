...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "Check your Creator Score and track your onchain content across Base and other networks",
    other: {
      "fc:frame": frameMetadata,
      "og:title": (process.env.NEXT_PUBLIC_ONCHAINKIT_PROJECT_NAME || "Creator Score") as string,
      "og:description": "Check your Creator Score and track your onchain content across Base and other networks",
      "og:image": (process.env.NEXT_PUBLIC_APP_HERO_IMAGE || "") as string,
      "twitter:card": "summary_large_image",
      "twitter:title": (process.env.NEXT_PUBLIC_ONCHAINKIT_PROJECT_NAME || "Creator Score") as string,
      "twitter:description": "Check your Creator Score and track your onchain content across Base and other networks",
    ...
    <html lang="en" className="h-full">
      <body className="min-h-full bg-white flex flex-col">
        <div className="relative flex flex-col w-full max-w-lg mx-auto bg-background overflow-hidden my-0 md:my-0 md:max-w-none md:mx-0 md:bg-white md:shadow-none md:rounded-none">
          <Providers>
            <Header />
            <main className="flex-1 flex flex-col w-full relative pb-32 overflow-y-auto">{children}</main>
            <BottomNav />
          </Providers>
        </div>
      </body>
