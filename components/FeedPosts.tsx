...
export function FeedPosts({ posts, paragraphCount, mirrorCount, totalCount }: FeedPostsProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        <h2 className="text-xl font-semibold">Latest Posts ({totalCount})</h2>
            ...
            <CardContent className="p-4">
              <div className="flex items-start justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  <button
                    onClick={() => handleGetPostUrl(post.clone, post.type)}
